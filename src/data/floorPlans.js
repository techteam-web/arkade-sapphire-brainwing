...
export const CATEGORIES = [
  {
    ...
    floors: [
      ...
      { id: "c-8-lg",   group: "C Wing", name: "8th Floor (Unit 2)",           config: "3 BHK", carpet: "1194 sq.ft.", deck: "—",          img: "/floorplans/Sapphire Residencial plan/wing-c-8-3bhk.webp", views: [{ x: 39.0, y: 16.0, vp: 0 }, { x: 44.0, y: 88.0, vp: 2 }] },
